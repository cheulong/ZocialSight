...
declare let d3: any;
@Component({
  selector: 'oppo-word-cloud',
  templateUrl: './oppo-word-cloud.component.html',
  styleUrls: ['./oppo-word-cloud.component.scss']
})
export class OppoWordCloudComponent implements OnInit {
...
data=[];
  ...
  private buildSVG() {
    this.svg = D3.select("div.word-cloud2")
                    .append('svg')
